    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-brand-red/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.32em] text-brand-red mb-6" aria-label="Customer reviews">
          ...
          <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto">
            We're proud to have earned the trust of families and businesses across Southwest Washington. <strong className="text-brand-red">Here's what they have to say.</strong>
          </p>
        </div>

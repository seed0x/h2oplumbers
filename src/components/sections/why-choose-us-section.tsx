    ...
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-brand-cyan/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.32em] text-brand-cyan mb-6" aria-label="Why choose us">
          ...
          <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto">
            As a family business serving other families, we understand what matters most - <strong className="text-brand-cyan">reliable service, honest pricing,</strong> 
            and treating your home with the same care we'd give our own. Here's why families trust us:
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center p-6 bg-white rounded-xl shadow-lg border-2 border-brand-cyan/20 transform hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl group">

    ...
    <section className="py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-brand-red/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.32em] text-brand-red mb-6" aria-label="Our team">
          ...
          <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto">
            <strong className="text-brand-red">We're not just a team, we're a family.</strong> Get to know the friendly, professional faces who will be taking care of your home.
          </p>
        </div>
